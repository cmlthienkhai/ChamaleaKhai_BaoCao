...
Route::get('/timkiem', [SearchController::class,'index'])->name('search');
...
Route::get('/brand/{id}/products', [FrontendController::class, 'ProductsBrand'])->name('products.brand');
...
Route::get('/giohang', [CartController::class, 'showCart'])->name('cart.show');
Route::get('/thanhtoan', [CartController::class, 'Pay'])->name('pay');
Route::post('/giohang', [CartController::class, 'giohang'])->name('cart.add');
Route::get('/xoa/{id}', [CartController::class, 'deletecart'])->name('delete.cart');
Route::post('/thanhtoan', [CartController::class, 'thanhcong'])->name('cart.success');
//Post
...
Route::get('/category/{id}/product', [FrontendController::class, 'ProductsCategory'])->name('product.category');

//login & sigup
Route::get('/login', [FrontendController::class, 'login']);
Route::get('/sigup', [FrontendController::class, 'sigup']);
Route::get('dangnhap',[FrontendController::class,'login'])->name('frontend.login');
Route::get('dangky',[FrontendController::class,'sigup'])->name('frontend.sigup');
Route::post('/dang-nhap', [FrontendController::class.'postLogin'])->name('frontend.post-login');
