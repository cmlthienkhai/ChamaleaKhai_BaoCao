<!-- resources/views/brands/products-brand.blade.php -->
...
<div class="container">
    <div class="container-frame">
        <a href="{{ route('frontend.brands') }}" class="btn btn-primary">Quay lại</a>
        <h1 class="center-text" style="color: #37a6da;">{{ $brand->name }}</h1>
        @isset($list_product)
