<head>
    <style>
        ...
        .menu-desktop ul.main-menu li:hover a {
            color: #000000;
            /* Màu chữ của các mục menu khi hover */

        }

        .menu-desktop ul.main-menu li.active-menu a {
            color: #000000;
            /* Màu chữ của mục menu được chọn (active) */
            background-color: #ffffff;
            /* Màu nền của mục menu được chọn (active) */
        }

        /* Hiệu ứng màu khi hover cho submenu */
        .menu-desktop ul.main-menu li:hover ul.sub-menu li a {
            color: #4abae6;
            /* Màu chữ của mục menu được chọn (active) */
    ...
    <div class="container-menu-desktop">
        ...
        <div class="top-bar">
            <div class="content-topbar flex-sb-m h-full container">
                ...
                <div class="right-top-bar flex-w h-full">
                    ...
                    <li class="{{ Request::is('dangky') ? 'active-menu' : '' }}">
                        <a href="{{ route('frontend.sigup') }}"class="flex-c-m trans-04 p-lr-25">Đăng Ký</a>
                    </li>
                    <a href="http://localhost/WEB/chamaleakhai0027_cdtt/public" class="flex-c-m trans-04 p-lr-25">
                        Tài khoản
                    </a>
                    <a href="http://localhost/WEB/chamaleakhai0027_cdtt/public/admin/login"
        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <a href="{{ URL::TO('http://localhost/WEB/chamaleakhai0027_cdtt/public') }}"
                    style="color: #2d97ee; font-weight: bold; font-size: 20px;"><i>Football</i><b>TK</b></a>
                ...
                <div class="wrap-icon-header flex-w flex-r-m">
                    ...
                    <a href="{{ route('cart.show') }}" class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11">
