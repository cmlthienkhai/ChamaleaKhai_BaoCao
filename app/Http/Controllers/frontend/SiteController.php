...
{
    // Thay đổi số lượng sản phẩm trên mỗi trang tùy ý, 12 là ví dụ
    $perPage = 6;

    // Lấy danh sách sản phẩm với trạng thái là 1, sắp xếp theo ngày tạo giảm dần và sử dụng phân trang
    $list_product = Product::where('status', '=', 1)
        ->orderBy('created_at', 'DESC')
        ->paginate($perPage);

    // Truyền danh sách sản phẩm và số lượng sản phẩm trên mỗi trang vào view
